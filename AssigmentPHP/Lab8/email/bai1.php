<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $nguoigui = 'ducnmh.22ns@vku.udn.vn';
		    $matkhau = 'kiwl kmes hiio wqaf';// mật khẩu của tài khoản ngolequanvh@gmail.com
		    $tennguoigui = 'Hiệu cutephomaique';
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $mail->Subject = 'Gửi thư từ lớp PHP';      
                $noidungthu = "<b>Chào bạn toi la Hoàng Ngọc Hiệu siu cấp cute dễ xương ahihi!</b><br>Chúc an lành!" ;
