...
<body>
<form action="chu.php" method="POST" >
...
<input type="text" name="so" id="textfield" value=" <?php  echo htmlspecialchars($_POST["so"])  ?> " />
</p></td>
<td width="232"><label for="textfield2"></label>
<input type="text" name="chu" id="textfield2" value=" <?php echo htmlspecialchars("$chu")   ?> " /></td>
</tr>
</table>
</form>
</body>
