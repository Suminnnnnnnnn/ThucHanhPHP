...
<input type="text" name="so_dau" id="textfield" value=" <?php   echo htmlspecialchars($_POST["so_dau"]); ?>   "/></td>
<td width="152">Số kết thúc</td>
<td width="175"><label for="textfield2"></label>
<input type="text" name="so_cuoi" id="textfield2" value=" <?php   echo htmlspecialchars($_POST["so_cuoi"]); ?> "/></td>
</tr>
<tr>
...
<input type="text" name="tong" id="textfield4" value=" <?php   echo htmlspecialchars($tong); ?>  "/></td>
</tr>
<tr>
<td>Tích các số</td>
<td colspan="4"><label for="textfield5"></label>
<input type="text" name="tich" id="textfield5" value="<?php   echo htmlspecialchars($tich); ?>"/></td>
</tr>
<tr>
<td>Tổng các số chẵn</td>
<td colspan="4"><label for="textfield6"></label>
<input type="text" name="tong_chan" id="textfield6" value="<?php   echo htmlspecialchars($tong_chan); ?> "/></td>
</tr>
<tr>
<td>Tổng các số lẻ</td>
<td colspan="4"><label for="textfield7"></label>
<input type="text" name="tong_le" id="textfield7" value="<?php   echo htmlspecialchars($tong_le); ?>"/></td>
</tr>
<tr>
